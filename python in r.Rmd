...
```{python}
#cast_mv.to_csv('final_cleaned_HW2')  
```
# This last code did not run, but it does not affect the data overall.

```{pytyhon}
cast_mv[cast_mv.W_Rating > cast_mv.W_Rating.quantile(0.99999)]
```
